...
from iharm.inference.base.metric_util import reorder_image, to_y_channel
...
def calculate_niqe(img, crop_border=0, input_order='HWC', convert_to='y', mu_pris_param=None, cov_pris_param=None, gaussian_window=None):
    """Calculate NIQE (Natural Image Quality Evaluator) metric.
